...
const providerDefinitions = {
  none: {
    ...
    keyEnv: null,
    keyPrompt: "Provider API key (not used; press Enter)",
    modelEnv: null,
    defaultModel: "none",
    apiKeyOptional: true,
    modelOptional: true,
...
const primaryBaseUrl = providerDefinition.baseUrlEnv
  ...
  : "";
const primaryModel = providerDefinition.modelOptional
...
if (providerDefinition.keyEnv) values[providerDefinition.keyEnv] = primaryApiKey;
if (providerDefinition.modelEnv) values[providerDefinition.modelEnv] = primaryModel;
